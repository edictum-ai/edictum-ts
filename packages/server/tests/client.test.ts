...
import { EdictumServerClient, EdictumServerError, SAFE_IDENTIFIER_RE } from '../src/client.js'
...
describe('tag validation', () => {
  it('rejects too many tags', () => {
    ...
    expect(() => new EdictumServerClient({ baseUrl: 'https://x.com', apiKey: 'k', tags })).toThrow(
      'Too many tags',
    )
  })
  ...
  it('rejects C1 control char NEL in tag key', () => {
    expect(
      () =>
        new EdictumServerClient({
          baseUrl: 'https://x.com',
  ...
  it('rejects line separator U+2028 in tag value', () => {
    expect(
      () =>
        new EdictumServerClient({
          baseUrl: 'https://x.com',
  ...
  it('rejects paragraph separator U+2029 in tag key', () => {
    expect(
      () =>
        new EdictumServerClient({
          baseUrl: 'https://x.com',
...
describe('apiKey validation', () => {
  it('rejects empty apiKey', () => {
    expect(() => new EdictumServerClient({ baseUrl: 'https://x.com', apiKey: '' })).toThrow(
...
describe('apiKey validation', () => {
  ...
  it('rejects C1 control char NEL in apiKey', () => {
    expect(
