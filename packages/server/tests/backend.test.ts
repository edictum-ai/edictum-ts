...
describe('ServerBackend.increment', () => {
  ...
  it('rejects NaN amount', async () => {
    ...
    await expect(backend.increment('counter', NaN)).rejects.toThrow(EdictumConfigError)
  })
  ...
  it('rejects Infinity amount', async () => {
    ...
    await expect(backend.increment('counter', Infinity)).rejects.toThrow(EdictumConfigError)
  })
